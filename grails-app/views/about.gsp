...
<html>
	...
	<body>
		...
		<p>Pieuvre is the french word for octopus.</p>
		...
		<p>The Pieuvre gathers contents from all sort of Internet sources, thus it is natural for the Pieuvre to redistribute those contents.</p>

		<p>Our goal is to make the Pieuvre accessible to all sort of applications and let people find new way of displaying and sharing information.</p>
