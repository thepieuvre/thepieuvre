...
environments {
    development {
        ...
        thepieuvre.feeder.python = '/usr/bin/python'
        thepieuvre.feeder.cmd = '/Users/adc/The Pieuvre/console/src/python/feeder/feeder.py'
...
grails.plugins.springsecurity.authority.className = 'thepieuvre.security.Role'
...
grails.plugins.springsecurity.controllerAnnotations.staticRules = [
    ...
    '/logout/**': ['IS_AUTHENTICATED_FULLY', 'IS_AUTHENTICATED_ANONYMOUSLY'],
    '/images/**': ['permitAll'],
    '/css/**': ['permitAll'],
    '/js/**': ['permitAll'],
    '/error/**': ['permitAll'],
...
log4j = {
  ...
  appenders {
    console name:'stdout', layout:pattern(conversionPattern: '%d{ABSOLUTE} %5p %10X{user} [%t] %c{4}:%L - %m%n')
  }
